		...
		<div class="panel-body">	
			...
			<form class="borde" action="Registrar_Clubes.php" method="POST" class="form" id="Formulario_Clubes">
				...
				<div class="Departamento">
					...
					<select name="Departamentos" class="Col" id="Departamentos" onchange="hideDepartamento(this.value)">
					...
					<select class="Ciudad Col" name="Ciudad" id="Ciudad" style="display:none;margin: 0.0em 2.0em;"></select>
					
					<input class="Bogota Col" readonly TYPE="text" NAME="Ciudad1" value="Bogotá D.C" maxlength="20" style="display:none;margin: 0.0em 2.0em"> <br /><p></p>
				...
				<input TYPE="number" NAME="Telefono" class="Corto" maxlength="10" onkeypress="return Numeros(event)" onpaste="return false" required> <br /><p></p> <br />
				...
				<select name="Reconocimiento" class="Select" onchange="hideReconocimiento(this.value)" required>
...
?>		
	...
	<!-- Main -->
	<script src="../dist/js/main-clubes.js"></script>
