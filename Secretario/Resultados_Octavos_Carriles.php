				...
				<div class="col-sm-12">
					<div class="justify-content-end align-items-center"><!--d-flex -->
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Resultados Octavos</li>
						</ol>
					</div>
		  ...
		  <div class="modal-body">
			  <form id="frmsubir" onsubmit="event.preventDefault();" >
				  <div class="form-group">
					  <input type="hidden" class="form-control" id="fase" name="fase" value="Octavos" required>
...
<script type="text/javascript">
	$('#tabla').load('Tabla_Octavos_Carriles.php');
	...
	function CargarModal(id){
 		...
 		$.ajax({
			...
			success:function(r){
				...
				var tiempo = datos['tiempo_octavos'];
				if(tiempo === null){
					console.log('ok');
				}else{
				...
				$.ajax({
					...
					success:function(R){
						if(R=="NULL"){
							...
							window.open('Resultados_Cuartos_Carriles.php?id='+<?php echo $id_listado; ?>,'_self');
						}
					}
				});
			},function(){
