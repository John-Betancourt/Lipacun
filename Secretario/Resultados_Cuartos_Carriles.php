				...
				<div class="col-sm-12">
					<div class="justify-content-end align-items-center"><!--d-flex -->
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Resultados Cuartos</li>
						</ol>
					</div>
		  ...
		  <div class="modal-body">
			  <form id="frmsubir" onsubmit="event.preventDefault();" >
				  <div class="form-group">
					  <input type="hidden" class="form-control" id="fase" name="fase" value="Cuartos" required>
...
<script type="text/javascript">
	$('#tabla').load('Tabla_Cuartos_Carriles.php');
	...
	function CargarModal(id){
 		...
 		$.ajax({
			...
			success:function(r){
				...
				var tiempo = datos['tiempo_cuartos'];
				if(tiempo === null){
					console.log('ok');
				}else{
				...
				$.ajax({
					...
					success:function(R){
						if(R=="NULL"){
							...
							window.open('Resultados_Semifinal_Carriles.php?id='+<?php echo $id_listado; ?>,'_self');
						}
					}
				});
			},function(){
