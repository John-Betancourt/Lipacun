...
<div class="tabla">
	...
	<table id="idDataTable1" class="display table table-hover table-striped table-bordered" style="width:100%">
		...
		<?php
			...
			$sql = "SELECT * FROM resultados_eventos_competencia_carriles WHERE nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_cuartos = 1 OR nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_cuartos = 5 ORDER BY `posicion_cuartos` ASC" ;
			$result = $mysqli->query($sql);
			while($row = $result->fetch_assoc()){
				
		?>
			<tr>
				<td><center><?php echo $row['posicion_cuartos'] ?></center></td>
				<td><center><?php echo $row['numero_deportista'] ?></center></td>
				<td><?php echo $row['nombres'] ?></td>
				<td><?php echo $row['club'] ?></td>
				<td><?php echo $row['observacion'] ?></td>
				<td><?php echo $row['tiempo_cuartos'] ?></td>
...
<div class="tabla">
	...
	<table id="idDataTable2" class="display table table-hover table-striped table-bordered" style="width:100%">
		...
		<?php
			...
			$sql = "SELECT * FROM resultados_eventos_competencia_carriles WHERE nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_cuartos = 2 OR nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_cuartos = 6 ORDER BY `posicion_cuartos` ASC" ;
			$result = $mysqli->query($sql);
			while($row = $result->fetch_assoc()){
...
<div class="tabla">
	...
	<table id="idDataTable3" class="display table table-hover table-striped table-bordered" style="width:100%">
		...
		<?php
			...
			$sql = "SELECT * FROM resultados_eventos_competencia_carriles WHERE nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_cuartos = 3 OR nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_cuartos = 7 ORDER BY `posicion_cuartos` ASC" ;
			$result = $mysqli->query($sql);
			while($row = $result->fetch_assoc()){
...
<div class="tabla">
	...
	<table id="idDataTable4" class="display table table-hover table-striped table-bordered" style="width:100%">
		...
		<?php
			...
			$sql = "SELECT * FROM resultados_eventos_competencia_carriles WHERE nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_cuartos = 4 OR nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_cuartos = 8 ORDER BY `posicion_cuartos` ASC" ;
			$result = $mysqli->query($sql);
			while($row = $result->fetch_assoc()){
