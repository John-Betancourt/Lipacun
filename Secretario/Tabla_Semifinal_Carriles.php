...
<div class="tabla">
	<center><h3>Semifinal 1</h3></center>
	<table id="idDataTable1" class="display table table-hover table-striped table-bordered" style="width:100%">
		...
		<?php
			...
			$sql = "SELECT * FROM resultados_eventos_competencia_carriles WHERE nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_semifinal = 1 OR nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_semifinal = 4 ORDER BY `posicion_semifinal` ASC" ;
			$result = $mysqli->query($sql);
			while($row = $result->fetch_assoc()){
				
		?>
			<tr>
				<td><center><?php echo $row['posicion_semifinal'] ?></center></td>
				<td><center><?php echo $row['numero_deportista'] ?></center></td>
				<td><?php echo $row['nombres'] ?></td>
				<td><?php echo $row['club'] ?></td>
				<td><?php echo $row['observacion'] ?></td>
				<td><?php echo $row['tiempo_semifinal'] ?></td>
...
<div class="tabla">
	<center><h3>Semifinal 2</h3></center>
	<table id="idDataTable2" class="display table table-hover table-striped table-bordered" style="width:100%">
		...
		<?php
			...
			$sql = "SELECT * FROM resultados_eventos_competencia_carriles WHERE nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_semifinal = 2 OR nombre_evento ='$Evento' AND id_listado = '$id_listado' AND posicion_semifinal = 3 ORDER BY `posicion_semifinal` ASC" ;
			$result = $mysqli->query($sql);
			while($row = $result->fetch_assoc()){
